...
namespace Pronia.Migrations
{
    ...
    [Migration("20230803170249_UpdateModelsEmployee")]
    partial class UpdateModelsEmployee
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pronia.Areas.AppAdmin.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Pronia.Models.Sku", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Pronia.Areas.AppAdmin.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pronia.Models.Product", b =>
                {
                    ...
                    b.HasOne("Pronia.Models.Sku", "SKU")
                        .WithMany("Products")
                        .HasForeignKey("SkuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
